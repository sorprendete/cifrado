...
CREATE TABLE IF NOT EXISTS `mensajes` (
  ...
  `payload_cifrado` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Volcando estructura para tabla db_mensajeria.rate_limits
CREATE TABLE IF NOT EXISTS `rate_limits` (
  `ip` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `endpoint` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `intentos` int DEFAULT '1',
  `ultimo_intento` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ip`,`endpoint`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla db_mensajeria.rate_limits: ~3 rows (aproximadamente)
INSERT INTO `rate_limits` (`ip`, `endpoint`, `intentos`, `ultimo_intento`) VALUES
	('eff8e7ca506627fe15dda5e0e512fcaad70b6d520f37cc76597fdb4f2d83a1a3', 'login', 2, '2026-06-09 22:21:05'),
	('eff8e7ca506627fe15dda5e0e512fcaad70b6d520f37cc76597fdb4f2d83a1a3', 'registro', 1, '2026-06-09 22:20:14'),
	('eff8e7ca506627fe15dda5e0e512fcaad70b6d520f37cc76597fdb4f2d83a1a3', 'verificar_usuario', 3, '2026-06-09 22:20:54');
...
CREATE TABLE IF NOT EXISTS `sesiones` (
  ...
  `dispositivo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Desconocido',
  `ip` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0.0.0.0',
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `alias_publico` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `llave_publica` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `boveda_cifrada` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `rol` enum('usuario','admin') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'usuario',
